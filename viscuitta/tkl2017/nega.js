...
(function (document, window, console) {
    ...
    let config = {
        ...
        "polygons": [
            ...
            <g class='base hide'>
            <polygon fill="${bcolor}" stroke-width="10" points='0 0, ${g_len} 0, ${g_len * (1 + g_ac)} ${g_len * g_as},${g_len * g_ac} ${g_len * g_as}' stroke='${fcolor}' stroke-linejoin="round"></polygon>
            <polygon fill="${fcolor}" points='${(0 + g_len) / 2} ${(0 + 0) / 2},${(g_len + g_len * (1 + g_ac)) / 2} ${(0 + g_len * g_as) / 2},${(g_len * (1 + g_ac) + g_len * g_ac) / 2} ${(g_len * g_as + g_len * g_as) / 2},${(g_len * g_ac + 0) / 2} ${(g_len * g_as + 0) / 2}' ></polygon>
            </g>
            <g transform="translate(${-g_len / 2},${-g_len})">
            <image class='img0 hide' href="./image2/0/30.png"/>
            <image class='img0-2 hide' href="./image2/0/30-2.png"/>
            <!--
            ...
            <g class='base hide'>
            <polygon fill="${bcolor}" stroke-width="10" points='0 0, ${g_len} 0, ${g_len * (1 + g_ac1)} ${g_len * g_as1},${g_len * g_ac1} ${g_len * g_as1}' stroke='${fcolor}' stroke-linejoin="round"></polygon>
            <polygon fill="${fcolor}" points='${(0 + g_len) / 2} ${(0 + 0) / 2},${(g_len + g_len * (1 + g_ac1)) / 2} ${(0 + g_len * g_as1) / 2},${(g_len * (1 + g_ac1) + g_len * g_ac1) / 2} ${(g_len * g_as1 + g_len * g_as1) / 2},${(g_len * g_ac1 + 0) / 2} ${(g_len * g_as1 + 0) / 2}' ></polygon>
            </g>
            <g transform="translate(${-g_len / 2},${-g_len / 2})">
            <image class='img0 hide' href="./image2/0/60.png"/>
            <image class='img0-2 hide' href="./image2/0/60-2.png"/>
            <!--
            ...
            <g class='base hide'>
             <polygon fill="${bcolor}" stroke-width="10" points='0 0, ${g_len} 0, ${g_len * (1 + g_ac2)} ${g_len * g_as2},${g_len * g_ac2} ${g_len * g_as2}' stroke='${fcolor}' stroke-linejoin="round"></polygon>
             <polygon fill="${fcolor}" points='${(0 + g_len) / 2} ${(0 + 0) / 2},${(g_len + g_len * (1 + g_ac2)) / 2} ${(0 + g_len * g_as2) / 2},${(g_len * (1 + g_ac2) + g_len * g_ac2) / 2} ${(g_len * g_as2 + g_len * g_as2) / 2},${(g_len * g_ac2 + 0) / 2} ${(g_len * g_as2 + 0) / 2}' ></polygon>
             </g>
             <g transform="translate(${-g_len / 2},${-g_len / 2})">
            <image class='img0 hide' href="./image2/0/90.png"/>
            <image class='img0-2 hide' href="./image2/0/90-2.png"/>
            <!--
